...
df_domc['url'] = df_domc['url'].str.replace('ebookcentral.proquest.com/auth/lib/ucas/', 'ebookcentral.proquest.com')
df_fire['url'] = df_fire['url'].str.replace('ebookcentral.proquest.com/auth/lib/ucas/', 'ebookcentral.proquest.com')
